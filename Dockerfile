...
RUN /opt/android-sdk-linux/tools/bin/sdkmanager "platforms;android-24"

RUN /opt/android-sdk-linux/tools/bin/sdkmanager "system-images;android-24;google_apis;x86_64"
